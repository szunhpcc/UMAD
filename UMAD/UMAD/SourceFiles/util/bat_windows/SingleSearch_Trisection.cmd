...
if "%dataType%"=="vector" set CurCMD=UMAD --runOption search --searchMode %SearchMode% --indexName vector_%Size%_%BuildMode%_v2_f3_m100_tR%tR% --n uniformvector-20dim-1m.txt --t vector --dim 20 --q uniformvector-20dim-1m.txt --fq 0 --l %lastQuery% --a 1.8 --i 0 --y 0.2 --ver 0 --init %Size% --buildMode %BuildMode% --res results_search_vector_datasize_%Size%_buildMode_%BuildMode%_searchMode_%SearchMode%.txt
if "%dataType%"=="string" set CurCMD=UMAD --runOption search --searchMode %SearchMode% --indexName string_%Size%_%BuildMode%_v2_f3_m100_tR%tR% --n English.dic --t string --dim 2 --q English.dic --fq 0 --l %lastQuery% --a 10 --i 0 --y 2 --ver 0 --init %Size% --buildMode %BuildMode% --res results_search_string_datasize_%Size%_buildMode_%BuildMode%_searchMode_%SearchMode%.txt
if "%dataType%"=="image" set CurCMD=UMAD --runOption search --searchMode %SearchMode% --indexName image_%Size%_%BuildMode%_v2_f3_m100_tR%tR% --n allfeas.dat --t image --dim 66 --q allfeas.dat --fq 0 --l %lastQuery% --a 0.3 --i 0 --y 0.05 --ver 0 --init %Size% --buildMode %BuildMode% --res results_search_image_datasize_%Size%_buildMode_%BuildMode%_searchMode_%SearchMode%.txt
if "%dataType%"=="dna" set CurCMD=UMAD --runOption search --searchMode %SearchMode% --indexName dna_%Size%_%BuildMode%_v2_f3_m100_tR%tR% --n dna.con --t dna --frag 18 --q dna.con --fq 0 --l %lastQuery% --a 10 --i 0 --y 1 --ver 0 --init %Size% --buildMode %BuildMode% --res results_search_dna_datasize_%Size%_buildMode_%BuildMode%_searchMode_%SearchMode%.txt
