...
if "%dataType%"=="vector" set CurCMD=UMAD --runOption search --searchMode %SearchMode% --indexName vector_%Size%_%BuildMode%_v2_f3_m100 --n uniformvector-20dim-1m.txt --t vector --dim 20 --q uniformvector-20dim-1m.txt --fq 0 --l %lastQuery% --a 1.8 --i 0 --y 0.2 --ver 0 --init %Size% --buildMode %BuildMode% --res results_search_vector_datasize_%Size%_buildMode_%BuildMode%_searchMode_%SearchMode%.txt
...
if "%dataType%"=="dna" set CurCMD=UMAD --runOption search --searchMode %SearchMode% --indexName dna_%Size%_%BuildMode%_v2_f3_m100 --n dna.con --t dna --frag 18 --q dna.con --fq 0 --l %lastQuery% --a 10 --i 0 --y 1 --ver 0 --init %Size% --buildMode %BuildMode% --res results_search_dna_datasize_%Size%_buildMode_%BuildMode%_searchMode_%SearchMode%.txt
