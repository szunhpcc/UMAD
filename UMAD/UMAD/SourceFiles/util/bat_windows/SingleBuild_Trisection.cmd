if "%dataType%"=="vector" set CurCMD=UMAD --runOption build --buildMode %BuildMode% --indexName vector_%Size%_%BuildMode%_v2_f3_m100_tR%tR% --n uniformvector-20dim-1m.txt --v 2 --f 3 --t vector --e MVPIndex --psm fft --dpm PivotWise --m 100 --init %Size% --F %Size% --s 2000 --dim 20 --res results_vector_build_%Size%i_%BuildMode%_fft_PivotWise_MVPIndex_v2_f3_m100_dim20_tR%tR%.txt --tR %tR% --sop %sop% --pbop %pbop%
